...
import introLogo from "../asset/introductionPage.png";
    ...
    <div className="body">
      <div className="hero bg-cover bg-center  bg-no-repeat flex flex-col flex-wrap">
        <div className="nav flex flex-row justify-evenly align-middle items-center pt-3 flex-wrap">
          ...
          <div>
            <button className="outline-none border-none p-2 bg-red-500 rounded-full text-white text-xs font-semibold">
              <p className="mx-1">Connect Wallet</p>
            </button>
          </div>
        </div>
